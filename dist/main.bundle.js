...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ngui_map__ = __webpack_require__("./node_modules/@ngui/map/dist/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_angularfire2_database_deprecated__ = __webpack_require__("./node_modules/angularfire2/database-deprecated/index.js");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_19_angularfire2_database_deprecated__["b" /* AngularFireDatabaseModule */],
...
/***/ "./src/app/demandelist/demandelist.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/demandelist/demandelist.component.html":
/***/ (function(module, exports) {

module.exports = "<ul>\n\n<div *ngFor=\"let cours of coursObservable | async\">\n\n<div type=\"info\" >\n\n<h3><a href=\"#\">{{cours.title}}</a> </h3>\n\n<p>{{cours.description}}</p>\n\n<div>\n\n<a href=\"{{cours.url}}\" target=\"_blank\" class=\"btn btn-danger\">Aller à {{cours.name}}</a>\n\n</div>\n\n</div>\n\n</div>\n\n</ul> \n"

/***/ }),

/***/ "./src/app/demandelist/demandelist.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DemandelistComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
...
var DemandelistComponent = (function () {
    function DemandelistComponent(afDb) {
        this.afDb = afDb;
    }
    DemandelistComponent.prototype.ngOnInit = function () {
        this.coursObservable = this.getCourses('/coursSupinfo');
    };
    DemandelistComponent.prototype.getCourses = function (listPath) {
...
DemandelistComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        template: __webpack_require__("./src/app/demandelist/demandelist.component.html"),
        styles: [__webpack_require__("./src/app/demandelist/demandelist.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_angularfire2_database__["a" /* AngularFireDatabase */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_angularfire2_database__["a" /* AngularFireDatabase */]) === "function" && _a || Object])
], DemandelistComponent);

var _a;
//# sourceMappingURL=demandelist.component.js.map
...
var MapsComponent = (function () {
    ...
    // marker.setMap(map);
    MapsComponent.prototype.getUrlParameter = function (sParam) {
...
module.exports = "<footer class=\"footer\">\n    <div class=\"container-fluid\">\n        <nav class=\"pull-left\">\n           <!--   <ul>\n\n                <li>\n                    <a href=\"https://www.creative-tim.com\">\n                        Creative Tim\n                    </a>\n                </li>\n                <li>\n                    <a href=\"http://blog.creative-tim.com\">\n                       Blog\n                    </a>\n                </li>\n                <li>\n                    <a href=\"https://www.creative-tim.com/license\">\n                        Licenses\n                    </a>\n                </li>\n            </ul> -->\n        </nav>\n        <div class=\"copyright pull-right\">\n            &copy; {{test | date: 'yyyy'}}, made with <i class=\"fa fa-heart heart\"></i> by <a href=\"https://seg.solutions\">SEG</a>\n        </div>\n    </div>\n</footer>\n"
...
var UserComponent = (function () {
    ...
    UserComponent.prototype.addToListmsgtosend = function (item) {
        console.log(item);
        var itemsmsgtosend = this.af.list('/boteventinboxer/msgtosend');
        itemsmsgtosend.push(item);
    };
    ...
    UserComponent.prototype.updateValuebesoin = function (data) {
        //  this.value.update(data).then(_ => console.log('update!'));
    };
    UserComponent.prototype.getUrlParameter = function (sParam) {
        return decodeURIComponent(window.location.search.substring(1)).split('&')
            .map(function (v) { return v.split("="); })
            .filter(function (v) { return (v[0] === sParam) ? true : false; })
            .reduce(function (prev, curv, index, array) { return curv[1]; }, undefined);
